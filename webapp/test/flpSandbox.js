		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DCCS Travel Requests",
									"targetURL": "#dccstravelrequests-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dccstravelrequests-display": {
								"semanticObject": "dccstravelrequests",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dccstravelrequests",
									"url": sap.ui.require.toUrl("dccstravelrequests")
								}
							}
						}
					}
